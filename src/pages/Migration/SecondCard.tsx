...
import { Card, CardHeader, CardBody, Text, Box, Button, Flex, ArrowDownIcon, Link } from '@zoeswap/uikit'
      ...
      <CardBody>
        ...
        <Card>
          <CardBody>
            ...
            <Button as={Link} external href="https://hiccup.zoeswap.finance/#/pool" style={{ width: '100%' }}>
              Remove
            </Button>
          </CardBody>
        </Card>
