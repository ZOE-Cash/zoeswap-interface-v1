...
import { Heading, Card, CardHeader, CardBody, Text, Button, Link, Flex, ArrowDownIcon } from '@zoeswap/uikit'
        ...
        <Wrapper>
          ...
          <Card mb="32px">
            ...
            <CardBody>
              ...
              <Button as={Link} external href="https://exchange.zoeswap.finance/#/pool" style={{ width: '100%' }}>
                Add liquidity
              </Button>
            </CardBody>
          </Card>
          ...
          <Card>
            ...
            <CardBody>
              ...
              <Button as={Link} external href="https://zoeswap.finance/farms" style={{ width: '100%' }}>
                Go to farms
              </Button>
            </CardBody>
          </Card>
